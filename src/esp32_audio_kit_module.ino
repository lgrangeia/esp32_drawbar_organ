...
#define KEY_SETTLE_VAL  9 /* use higher value if analog buton detection is unstable */
...
void button_loop()
{
    ...
    {
        Serial.println("PIN_KEY_1 pressed");
        /*
    ...
    {
        Serial.println("PIN_KEY_2 pressed");
    ...
    {
        Serial.println("PIN_KEY_3 pressed");
        /*if (buttonMapping.key5_pressed != NULL)
        {
            buttonMapping.key5_pressed();
        }*/
    ...
    {
        Serial.println("PIN_KEY_4 pressed");
        /*if (buttonMapping.key5_pressed != NULL)
        {
            buttonMapping.key5_pressed();
        }*/
    ...
    {
        Serial.println("PIN_KEY_5 pressed");
        /*if (buttonMapping.key5_pressed != NULL)
        {
            buttonMapping.key5_pressed();
        }*/
    ...
    {
        Serial.println("PIN_KEY_6 pressed");
